...
public class FourFragment extends Fragment {
    ...
    private FirebaseRecyclerAdapter<Joke, MainActivity.MyJokeViewHolder> mFirebaseAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //          .build();
         ...
         */
        mFirebaseAdapter = new FirebaseRecyclerAdapter<Joke, MainActivity.MyJokeViewHolder>(
                Joke.class,
                R.layout.item_joke_layout,
                MainActivity.MyJokeViewHolder.class,
                mFirebaseDatabaseReference.child(JOKES)) {

            @Override
            protected void populateViewHolder(MainActivity.MyJokeViewHolder viewHolder, final Joke joke, int position) {
                /**
