package com.google.firebase.codelab.friendlychat.twitterSignIn;
...
public class OneFragment1 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dbHelper = MainActivity1.getAsyncDBHelper();
        getJokes();
    ...
    private void getJokes() {
        ...
        // activity.
        SharedPreferences prefs = getActivity().getSharedPreferences("OnegetJokes",
                MODE_PRIVATE);
