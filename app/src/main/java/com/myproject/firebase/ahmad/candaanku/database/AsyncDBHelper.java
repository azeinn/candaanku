package com.myproject.firebase.ahmad.candaanku.database;
...
public class AsyncDBHelper {
	...
	private static final String CERITA = "CERITA";
	private static final String TEKATEKI = "TEKATEKI";
	...
	private class AsyncQueryTekateki extends AsyncTask<String[], Void, Cursor> {

		@Override
		protected Cursor doInBackground(String[]... params) {
			// Get the categories
			return database.getTekateki();
		}
	}

	public long addNewTekateki(String tekateki, String answer, String category) {
	...
	private class AsyncInsertTekateki extends AsyncTask<String, Void, Long> {

		@Override
		protected Long doInBackground(String... params) {
			if (params.length == 3) {
				return database.addNewTekateki(params[0], params[1], params[2]);
			}
	...
	private class AsyncDeleteTekateki extends AsyncTask<String, Void, Boolean> {

		@Override
		protected Boolean doInBackground(String... params) {
			if (params[0].equals(TEKATEKI)) {
				return database.deleteTekateki(Integer.parseInt(params[1]));
			}
