...
import com.myproject.firebase.ahmad.candaanku.Joke;
...
public class FourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     /*   if (mFirebaseUser == null) {
            String username = ((MainActivity)getActivity()).mUsername;
            if (username!=null)
      ...
      //          .build();
        ...
        mPostButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Joke joke = new Joke(mFirebaseUser.getUid(), mJokeEditText.getText().toString(), ((MainActivity)getActivity()).mUsername,
                        ((MainActivity)getActivity()).mPhotoUrl, key, likesGivenBy);
