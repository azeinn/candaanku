...
public class SplashActivity extends AwesomeSplash {
    ...
    /* you don't have to override every property */
		...
		configSplash.setBackgroundColor(R.color.mainBackground); //any color you want form colors.xml
		...
		//Customize Title
		configSplash.setTitleSplash("Cerita dan Teka-teki Lucu");
	...
	private class Task extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			// Do something before executing background task

		}

		@Override
		protected Void doInBackground(Void... arg0) {
			asyncDBHelper = new AsyncDBHelper(SplashActivity.this);
		...
		protected void onPostExecute(Void result) {
			...
			// do somethning after completing http calls or any background task
			//load some other activity
		}
	}
